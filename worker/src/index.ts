...
const systemPrompt = `Ты ведешь образовательную симуляцию для сайта по защите от мошенничества.

Роль:
- Ты играешь мошенника в учебной среде.
...
Сформируй следующую реплику мошенника и отдельный разбор.`
